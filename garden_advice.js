...
let season = prompt("Enter the current season:"); // TODO: Replace with prompt() to allow user interaction.
let plantType = prompt("Enter a plant type:"); // TODO: Replace with prompt() to allow user interaction.
